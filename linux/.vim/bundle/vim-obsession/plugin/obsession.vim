...
function! s:persist() abort
  ...
  if exists('g:this_obsession')
    ...
    try
      ...
      " mksession emits 'vim9script' as the first line on Vim 9+; in that
      " case these appended assignments must drop ':let' (E1126) since
      " global vars are assigned bare in Vim9 script.
      let let_ = get(body, 0, '') ==# 'vim9script' ? '' : 'let '
      call insert(body, let_ . 'g:this_session = v:this_session', -3)
      call insert(body, let_ . 'g:this_obsession = v:this_session', -3)
